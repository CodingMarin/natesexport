                    ...
                    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-12">
                        <div className="flex-col flex gap-y-10 justify-center items-center">
                            <div className="inline">
                                <Image
                                    src="/productos_organicos_edited.webp"
                            ...
                            <div className="inline">
                                <div className="bg-green-600 animate-bounce rounded-full shadow-lg transition duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-badge-down-filled" width="40" height="40" viewBox="0 0 24 24" strokeWidth="1" stroke="#fff" fill="none" strokeLinecap="round" strokeLinejoin="round">
