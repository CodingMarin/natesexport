    ...
    return (
        <div className="w-full mx-auto py-5">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="py-4">
                    <label htmlFor="telefono" className="text-sm text-[#091E42] font-medium">Telefono / Correo</label>
                ...
                <label htmlFor="name" className="pb-4 text-sm text-[#091E42] font-medium">Nombres / Apellidos</label>
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-5 justify-center">
                ...
                <div className="py-5">
                    <label htmlFor="message" className="block mb-2 text-sm font-medium text-[#091E42] ">Escribe tu solicitud aqui... *</label>
