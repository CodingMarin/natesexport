                    ...
                    < div className="px-5 max-w-7xl mx-auto flex gap-3 justify-between lg:justify-center items-center h-full w-full" >
                        ...
                        <div className="flex items-center gap-5">
                            <div type="button" className="lg:hidden flex order-1">
                                <div className="flex group items-center justify-between hover:bg-opacity-100 transition duration-500 border-slate-300 border-2 pl-1.5 md:pl-3 pr-1.5 w-full h-[32px] rounded">
                                    <div className="flex items-center justify-center">
                                        <button className="mx-1" onClick={() => setIsShowin(isShowing => !isShowing)}>
                                            <div className="space-y-1 group cursor-pointer relative w-4 h-[8px]">
                                                <span className="transition-all ease-out block h-0.5 bg-slate-300 group-hover:bg-slate-300 w-4"></span>
                                                <span className="transition-all ease-out block h-0.5 bg-slate-300 group-hover:bg-slate-300 w-4"></span>
                                                <span className="transition-all ease-out block h-0.5 bg-slate-300 group-hover:bg-slate-300 w-3"></span>
                                            </div>
                                        </button>
                                    </div>
                                </div>
